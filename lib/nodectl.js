...
if (actions.start) {
  ...
  if (cluster.isMaster) {
    ...
    if (options.watch) {
      ...
      _fn1 = function(watch) {
        if (!(new RegExp("^" + options.assets)).test(watch)) {
          try {
